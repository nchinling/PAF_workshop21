...
public class DBQueries {
    ...
    // public static final String SELECT_ORDERS_FOR_CUSTOMERS = "select c.id as customer_id, c.company, o.id as order_id, o.ship_name, o.shipping_fee from customer c, orders o where c.id = o.customer_id and customer_id = ?";
    public static final String SELECT_ORDERS_FOR_CUSTOMERS = "select c.id as customer_id, c.company, o.id as order_id, o.ship_name, o.shipping_fee from customer c, orders o where c.id = o.customer_id and customer_id = ?";
